    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Maintenance Informatique & GSM</h1>
                <p class="text-xl md:text-2xl mb-8">Devenez un technicien polyvalent en réparation d’ordinateurs, téléphones et équipements numériques</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">Pourquoi cette formation ?</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Le secteur de la maintenance informatique et GSM est en forte croissance. Cette formation vous donne les compétences pratiques et techniques pour diagnostiquer, réparer et optimiser des ordinateurs, smartphones, tablettes et autres équipements connectés. Elle allie électronique, informatique et téléphonie mobile pour faire de vous un technicien recherché sur le marché.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Apprendre le diagnostic et la réparation d'ordinateurs (hardware & software)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Maîtriser la maintenance des téléphones portables (Android/iOS)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser les outils et équipements professionnels (fer à souder, multimetre, etc.)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Installer et configurer des systèmes d’exploitation et logiciels courants</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">(Cours + ateliers pratiques)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">En présentiel à Lomé ou en ligne</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">75 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Matériel de base fourni</p>
                    </div>
                </div>

    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Maintenance Informatique & Réseau</h1>
                <p class="text-xl md:text-2xl mb-8">Devenez un technicien qualifié en réparation, installation et gestion des réseaux informatiques</p>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Le domaine de la maintenance informatique et du réseau est en pleine croissance. Cette formation vous donne toutes les compétences techniques pour dépanner des ordinateurs, configurer des réseaux, installer des systèmes d’exploitation, et garantir la sécurité des équipements informatiques. Que vous soyez débutant ou en reconversion, cette formation vous prépare efficacement au métier de technicien informatique.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Maîtriser le diagnostic et la réparation de pannes informatiques</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Installer, configurer et administrer un réseau local</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Assurer la sécurité des données et des équipements</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Intervenir efficacement en entreprise ou à domicile</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">En présentiel ou à distance</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">Formation + support + certification</p>
                    </div>
                </div>

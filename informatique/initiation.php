    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Initiation à l’informatique</h1>
                <p class="text-xl md:text-2xl mb-8">Découvrez les bases essentielles de l’informatique pour une utilisation professionnelle ou personnelle</p>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        L’informatique est aujourd’hui indispensable dans tous les domaines. Cette formation est conçue pour les débutants souhaitant acquérir les connaissances de base : manipulation de l’ordinateur, usage de Windows, traitement de texte, navigation sur Internet, envoi d’emails, etc. Aucune compétence préalable n’est requise.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Se familiariser avec les composants de l’ordinateur</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Maîtriser l’utilisation de Windows et de ses fonctionnalités de base</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Créer et modifier des documents avec Word</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Naviguer sur Internet et utiliser une boîte mail</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">(Cours + exercices pratiques)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">En présentiel uniquement</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">40 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Support + suivi personnalisé</p>
                    </div>
                </div>

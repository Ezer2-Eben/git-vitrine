    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Multimédia et Infographie</h1>
                <p class="text-xl md:text-2xl mb-8">Maîtrisez les outils de création graphique et audiovisuelle pour donner vie à vos idées</p>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Dans un monde visuel, les compétences en design graphique et multimédia sont très recherchées. Cette formation vous initie à la création de visuels professionnels, de vidéos, d’animations et à la retouche d’images avec des logiciels comme Photoshop, Illustrator, Premiere Pro, Canva, etc.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Créer des affiches, logos, flyers et cartes avec Canva ou Illustrator</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Retoucher des photos avec Photoshop</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Créer des vidéos et animations avec Premiere Pro ou des outils en ligne</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Comprendre les bases de la composition graphique et de la couleur</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">(Théorie + projets pratiques)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">Places limitées</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">60 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Licence logiciels + support inclus</p>
                    </div>
                </div>

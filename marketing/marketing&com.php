    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Marketing & Communication Digitale</h1>
                <p class="text-xl md:text-2xl mb-8">Boostez votre présence en ligne et engagez efficacement votre audience</p>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Cette formation vous donne les clés pour élaborer une stratégie de communication efficace à l'ère du numérique. Vous apprendrez à utiliser les réseaux sociaux, le marketing de contenu, le référencement et la publicité en ligne pour développer votre visibilité.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Comprendre les fondamentaux du marketing digital</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Créer et gérer des campagnes sur les réseaux sociaux (Facebook, Instagram, etc.)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser les outils de publicité (Meta Ads, Google Ads)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Analyser les résultats et ajuster une stratégie digitale</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">(Cours intensifs en présentiel et en ligne)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">15 Novembre 2025</p>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">55 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Accès aux outils numériques offert</p>
                    </div>
                </div>

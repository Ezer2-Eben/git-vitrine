    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Photographie & Traitement d'image</h1>
                <p class="text-xl md:text-2xl mb-8">Capturez, améliorez et sublimez vos photos comme un professionnel</p>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Maîtrisez les bases de la photographie numérique, l'art de la composition et les techniques de retouche d'image avec des outils comme Adobe Photoshop et Lightroom. Que vous soyez passionné ou futur professionnel, cette formation vous aide à sublimer vos clichés.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Maîtriser les réglages de l'appareil photo (ISO, ouverture, vitesse)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Apprendre les règles de composition d'une photo réussie</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser Photoshop pour corriger, retoucher et améliorer vos images</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Réaliser un portfolio photo professionnel</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">(Cours pratiques et séances sur terrain)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">21 Octobre 2025</p>
                        <p class="text-gray-600 text-sm">Inscription en cours</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">65 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Support et accès aux logiciels inclus</p>
                    </div>
                </div>

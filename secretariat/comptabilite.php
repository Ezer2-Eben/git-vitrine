    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Secrétariat comptabilité</h1>
                <p class="text-xl md:text-2xl mb-8">Alliez compétences administratives et bases solides en comptabilité pour devenir un professionnel polyvalent</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">L'importance du secrétariat comptabilité</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Le secrétariat comptabilité joue un rôle clé dans le fonctionnement d’une entreprise. Il allie rigueur administrative et notions essentielles en gestion comptable. Cette formation vous permet d’acquérir les compétences nécessaires pour assurer le suivi administratif et comptable, tout en maîtrisant les logiciels de bureautique et de comptabilité. Une opportunité pour accéder à des postes polyvalents recherchés dans le secteur public et privé.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Comprendre les bases de la comptabilité générale (journal, bilan, compte de résultat)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser les logiciels comptables et bureautiques (Excel, Word, logiciels de gestion comptable)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Gérer les documents administratifs et comptables (factures, bons de commande, pièces justificatives)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Assurer le suivi des opérations courantes : encaissements, décaissements, rapprochements bancaires</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Développer la rigueur et l'organisation pour garantir la fiabilité des données traitées</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="space-y-4">
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 1 : Comptabilité de base</h3>
                            <p class="text-gray-700">Notions fondamentales, journalisation, bilan simplifié, suivi des écritures</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 2 : Logiciels comptables et bureautiques</h3>
                            <p class="text-gray-700">Excel appliqué à la comptabilité, initiation à un logiciel de comptabilité (ex. Sage, Wave)</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 3 : Gestion administrative et financière</h3>
                            <p class="text-gray-700">Traitement des factures, gestion de trésorerie, classement des pièces comptables</p>
                        </div>
                    </div>
                </div>

    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Secrétariat caisse</h1>
                <p class="text-xl md:text-2xl mb-8">Devenez un professionnel de la gestion de caisse et des opérations administratives liées à la comptabilité</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">L'importance du secrétariat caisse</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Le secrétariat caisse joue un rôle clé dans la bonne gestion financière d'une entreprise ou d'une structure. Cette formation vous prépare à assurer la gestion des encaissements et décaissements, à suivre les mouvements financiers, à produire des documents comptables simples et à entretenir une relation de confiance avec les clients. Vous apprendrez à manier les outils de caisse et les logiciels de gestion, tout en respectant les normes de confidentialité et de rigueur exigées par la profession.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Savoir enregistrer et suivre les opérations de caisse (encaissements, décaissements, rapprochements)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Maîtriser l'utilisation des logiciels de gestion de caisse (Excel, logiciels de caisse spécifiques)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Assurer la rédaction et la tenue des pièces justificatives (reçus, bordereaux, fiches de caisse)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Appliquer les règles de sécurité et de confidentialité liées à la gestion de l'argent</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Développer un bon sens du relationnel avec les clients et les collaborateurs</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">3 mois</p>
                        <p class="text-gray-600 text-sm">(12 semaines, 300 heures)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">15 Septembre 2025</p>
                        <p class="text-gray-600 text-sm">Inscriptions jusqu'au 10/09</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <h3 class="text-xl font-bold text-dark mb-2">Coût de formation</h3>
                        <p class="text-gray-700 font-medium">150 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Paiement échelonné possible</p>
                    </div>
                </div>

                <!-- Programme détaillé -->
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-secondary mb-6">Programme détaillé</h2>
                    <div class="space-y-4">
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 1 : Gestion de caisse</h3>
                            <p class="text-gray-700">Techniques de caisse, encaissements, décaissements, caisse journalière, tenue du registre</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 2 : Logiciels et outils de caisse</h3>
                            <p class="text-gray-700">Excel appliqué à la comptabilité, initiation aux logiciels de caisse et de comptabilité</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 3 : Communication et service client</h3>
                            <p class="text-gray-700">Accueil, gestion des réclamations, communication avec la hiérarchie et les clients</p>
                        </div>
                    </div>
                </div>

        ...
        <section class="hero-section text-white py-20">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Secrétariat Bureautique</h1>
                    <p class="text-xl md:text-2xl mb-8">Acquérez les compétences clés pour exceller dans les métiers administratifs modernes</p>
            ...
            <div class="container mx-auto px-4">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="mb-12 highlight-box">
                        <h2 class="text-2xl font-bold text-secondary mb-4">L'importance du secrétariat bureautique</h2>
                        <p class="text-gray-700 leading-relaxed">
                            Dans un environnement professionnel en constante évolution, le secrétariat bureautique représente la colonne vertébrale des opérations administratives. Cette formation intensive vous permettra de maîtriser les outils informatiques indispensables (Word, Excel, PowerPoint, Outlook) tout en développant les compétences organisationnelles et relationnelles essentielles pour gérer efficacement un bureau moderne. Une certification reconnue qui ouvre les portes à des opportunités dans tous les secteurs d'activité.
                        </p>
                    </div>
                    ...
                    <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700">Maîtriser les fonctionnalités avancées des logiciels bureautiques (traitement de texte, tableurs, présentations)</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                    <i class="fas fa-check text-xs"></i>
                                </span>
                                <span class="text-gray-700">Gérer efficacement la communication écrite et électronique (courriers, emails, rapports)</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                    <i class="fas fa-check text-xs"></i>
                                </span>
                                <span class="text-gray-700">Organiser et classer les documents administratifs (physiques et numériques)</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                    <i class="fas fa-check text-xs"></i>
                                </span>
                                <span class="text-gray-700">Planifier et coordonner des réunions (agendas, convocations, comptes-rendus)</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                    <i class="fas fa-check text-xs"></i>
                                </span>
                                <span class="text-gray-700">Développer des compétences en accueil et relation client (téléphone, visites)</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="space-y-4">
                            <div class="border-l-2 border-primary pl-4">
                                <h3 class="font-bold text-dark">Module 1 : Maîtrise des outils bureautiques</h3>
                                <p class="text-gray-700">Word avancé, Excel (formules, tableaux croisés dynamiques), PowerPoint professionnel</p>
                            </div>
                            <div class="border-l-2 border-primary pl-4">
                                <h3 class="font-bold text-dark">Module 2 : Gestion administrative</h3>
                                <p class="text-gray-700">Classement et archivage, gestion du courrier, organisation des dossiers</p>
                            </div>
                            <div class="border-l-2 border-primary pl-4">
                                <h3 class="font-bold text-dark">Module 3 : Communication professionnelle</h3>
                                <p class="text-gray-700">Rédaction administrative, gestion des emails, communication téléphonique</p>
                            </div>
                        </div>
                    </div>

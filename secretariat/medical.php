    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Secrétariat médical</h1>
                <p class="text-xl md:text-2xl mb-8">Devenez l’interface essentielle entre les patients et les professionnels de santé</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">Pourquoi se former en secrétariat médical ?</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Le secrétaire médical assure un rôle essentiel dans la gestion des dossiers, l’accueil des patients et la coordination avec les praticiens. Cette formation prépare les participants à maîtriser les outils administratifs, la terminologie médicale et les exigences spécifiques au secteur de la santé. Un métier humain, organisé et indispensable dans tous les établissements de soins.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Maîtriser la terminologie médicale et les bases d’anatomie</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Accueillir les patients et organiser les rendez-vous médicaux</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Gérer les dossiers médicaux et les comptes-rendus de consultation</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser les outils bureautiques spécifiques au milieu médical</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Respecter la confidentialité et la réglementation en vigueur</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="space-y-4">
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 1 : Accueil et communication médicale</h3>
                            <p class="text-gray-700">Prise de rendez-vous, accueil téléphonique, gestion des urgences et confidentialité</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 2 : Terminologie médicale & anatomie de base</h3>
                            <p class="text-gray-700">Identification des termes médicaux usuels et lecture des ordonnances</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 3 : Outils de bureautique et gestion documentaire</h3>
                            <p class="text-gray-700">Word, Excel, messagerie professionnelle, archivage numérique sécurisé</p>
                        </div>
                    </div>
                </div>

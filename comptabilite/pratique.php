    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Comptabilité Pratique</h1>
                <p class="text-xl md:text-2xl mb-8">Maîtrisez les fondamentaux de la comptabilité pour gérer efficacement les finances d'une entreprise</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">L'importance de la comptabilité pratique</h2>
                    <p class="text-gray-700 leading-relaxed">
                        La comptabilité est essentielle pour suivre la santé financière d'une entreprise, prendre des décisions éclairées et respecter les obligations fiscales. Cette formation vous permet d'acquérir les compétences nécessaires pour enregistrer les opérations comptables courantes, établir les documents financiers de base, utiliser des logiciels comptables et analyser les données financières de manière pratique.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Comprendre les principes de base de la comptabilité générale</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Savoir enregistrer les opérations comptables courantes (achats, ventes, banques, salaires...)</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Établir un journal, un grand livre et une balance</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser Excel et des logiciels comptables pour automatiser les tâches</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Préparer un bilan comptable simplifié et un compte de résultat</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="space-y-4">
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 1 : Introduction à la comptabilité</h3>
                            <p class="text-gray-700">Notions de base, terminologie comptable, rôle de la comptabilité</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 2 : Enregistrement des opérations</h3>
                            <p class="text-gray-700">Journal, grand livre, balance, écritures comptables courantes</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 3 : Logiciels et outils comptables</h3>
                            <p class="text-gray-700">Comptabilité sur Excel, initiation à un logiciel de comptabilité (ex : Sage, Wave)</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 4 : États financiers</h3>
                            <p class="text-gray-700">Bilan, compte de résultat, lecture et analyse des états financiers</p>
                        </div>
                    </div>
                </div>

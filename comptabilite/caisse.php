    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Formation en Comptabilité Caisse</h1>
                <p class="text-xl md:text-2xl mb-8">Maîtrisez les bases pratiques de la comptabilité axée sur la gestion de caisse au sein des entreprises</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">Pourquoi la comptabilité caisse est essentielle</h2>
                    <p class="text-gray-700 leading-relaxed">
                        La comptabilité caisse est une compétence de base indispensable pour toute personne impliquée dans la gestion financière d’une organisation. Cette formation vous permet de maîtriser l'enregistrement des opérations quotidiennes de caisse, la tenue de livres comptables, le contrôle des flux d'argent, et le respect des procédures comptables et fiscales. Elle constitue un socle solide pour évoluer vers des postes comptables plus avancés.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Comprendre les principes de base de la comptabilité caisse</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Enregistrer correctement les encaissements et décaissements</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Tenir à jour les journaux et livres de caisse</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Établir des états de rapprochement de caisse fiables</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Appliquer les règles comptables et fiscales liées à la gestion de trésorerie</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="space-y-4">
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 1 : Principes de la comptabilité</h3>
                            <p class="text-gray-700">Notions de base, journal de caisse, plan comptable simplifié</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 2 : Techniques de gestion de caisse</h3>
                            <p class="text-gray-700">Encaissements/décaissements, caisse journalière, erreurs courantes et contrôle</p>
                        </div>
                        <div class="border-l-2 border-primary pl-4">
                            <h3 class="font-bold text-dark">Module 3 : Applications pratiques et outils</h3>
                            <p class="text-gray-700">Utilisation d’Excel pour la comptabilité, initiation à un logiciel de compta, cas pratiques</p>
                        </div>
                    </div>
                </div>

    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Comptabilité, Audit & Finance</h1>
                <p class="text-xl md:text-2xl mb-8">Développez vos compétences en gestion financière, contrôle et audit avec des outils et méthodes professionnels</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">Présentation</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Cette formation est destinée à toute personne souhaitant maîtriser les principes fondamentaux et les pratiques avancées en comptabilité générale, audit financier et analyse financière. À travers des cas concrets et des outils modernes, vous serez en mesure de produire, d’analyser et de contrôler les états financiers d’une entreprise.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Maîtriser les bases de la comptabilité générale et analytique</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Comprendre les mécanismes de l’audit interne et externe</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Élaborer et analyser les états financiers d'une entreprise</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Utiliser des outils numériques pour la comptabilité et l’analyse financière</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">2 mois</p>
                        <p class="text-gray-600 text-sm">(avec exercices pratiques chaque semaine)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">14 Octobre 2025</p>
                        <p class="text-gray-600 text-sm">Formation mixte (présentiel + en ligne)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">120 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Supports numériques et accès plateforme inclus</p>
                    </div>
                </div>

                <!-- Thèmes abordés -->
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-secondary mb-6">Thèmes principaux</h2>
                    <ul class="list-disc list-inside text-gray-700 leading-relaxed space-y-2">
                        <li>Principes comptables et enregistrement des écritures</li>
                        <li>Gestion de la trésorerie et rapprochements bancaires</li>
                        <li>Audit des comptes – processus et outils</li>
                        <li>Analyse financière : ratios, BFR, capacité d’autofinancement</li>
                        <li>Introduction à la fiscalité d’entreprise</li>
                        <li>Utilisation de logiciels de comptabilité (Sage, Excel avancé, etc.)</li>
                    </ul>
                </div>

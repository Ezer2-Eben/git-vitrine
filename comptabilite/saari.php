    ...
    <section class="hero-section text-white py-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Sage SAARI Gestion Commerciale vs Sage i7</h1>
                <p class="text-xl md:text-2xl mb-8">Maîtrisez les différences clés entre deux générations de logiciels de gestion commerciale</p>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 highlight-box">
                    <h2 class="text-2xl font-bold text-secondary mb-4">Pourquoi comparer Sage SAARI et Sage i7 ?</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Sage SAARI et Sage i7 sont deux versions phares du logiciel Sage pour la gestion commerciale. Tandis que SAARI a longtemps été une référence, Sage i7 apporte une nouvelle architecture, plus d’automatisation, et une meilleure compatibilité avec les environnements modernes. Cette formation vous permet de comprendre les différences fonctionnelles, ergonomiques et techniques pour faire un choix éclairé ou réussir une migration.
                    </p>
                </div>
                ...
                <div class="mb-12 bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Maîtriser les fonctionnalités de base et avancées de Sage SAARI GC</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Découvrir les nouveautés de l’interface Sage i7</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Savoir migrer de SAARI vers i7</span>
                        </li>
                        <li class="flex items-start">
                            <span class="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-xs"></i>
                            </span>
                            <span class="text-gray-700">Comprendre les limites de chaque version selon vos besoins métier</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">(4 semaines intensives)</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">En présentiel et en ligne</p>
                    </div>
                    ...
                    <div class="info-card bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">100 000 FCFA</p>
                        <p class="text-gray-600 text-sm">Matériel fourni, accès logiciel inclus</p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <a href="#" class="bg-primary text-dark font-bold px-8 py-3 rounded-lg hover:bg-yellow-500 transition duration-300 inline-block">
                        <i class="fas fa-file-download mr-2"></i> Télécharger le comparatif
                    </a>
                </div>
            </div>
        </div>
